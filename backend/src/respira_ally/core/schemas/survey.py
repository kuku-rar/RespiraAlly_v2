...
class CATSurveyAnswers(BaseModel):
    ...
    q3_chest_tightness: int = Field(
        ..., ge=0, le=5, description="胸部緊繃感 (0=完全不緊, 5=非常緊)"
    )
    q4_breathlessness_stairs: int = Field(
        ..., ge=0, le=5, description="爬坡/樓梯時喘不過氣 (0=不會, 5=非常喘)"
    )
    q5_activity_limitation: int = Field(
        ..., ge=0, le=5, description="居家活動受限 (0=無限制, 5=非常受限)"
    )
    q6_confidence_leaving_home: int = Field(
        ..., ge=0, le=5, description="外出信心 (0=很有信心, 5=完全沒信心)"
    )
    q7_sleep_quality: int = Field(..., ge=0, le=5, description="睡眠品質 (0=睡得很好, 5=睡不好)")
    q8_energy_level: int = Field(
        ..., ge=0, le=5, description="精力充沛程度 (0=充滿精力, 5=完全沒精力)"
    )
